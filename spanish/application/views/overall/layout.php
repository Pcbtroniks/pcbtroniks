    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        ...
        <ul>
          ...
          <li class="active"><a href="<?= base_url(); ?>#topbar">Inicio</a></li>
          ...
          ?>
            ...
            <li><a href="<?= base_url(); ?>clientes/soporte/">Solicitar Soporte Técnico</a></li>

            <li><a href="<?= base_url(); ?>authentication/logout/">Cerrar sesión</a></li>

          <?php else: ?>

            <li><a href="<?= base_url(); ?>clientes">Soy Cliente</a></li>

          <?php endif; ?>

          <li><a href="https://pcbtroniks.com/en/" class="btn-get-started animated fadeInUp scrollto">English</a></li>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#header">Inicio</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#about">Nostros</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#services">Servicios</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#terminos">Terminos de servicio</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#privacidad">Politica de privacidad</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>#contact">Trabajo</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>clientes">Clientes</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>solicitar-cotizacion">Cotizaciones</a></li>

              <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url(); ?>clientes/soporte">Enviar Reporte</a></li>
    ...
    <div class="container">
      ...
      <div class="copyright">
        ...
        &copy; Copyright <strong><span>Pcbtroniks</span></strong>. Todos los derechos reservados
